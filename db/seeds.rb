...
Job.destroy_all
Job.create(jobtitle: 'Lead dev', jobdescription: "write sweet code", postinglink: 'www.codemaster.com', dateofposting: '11/11/11', salary: '100', careerfield: 'technology', dateappliedto: '12/12/11')
Job.create(jobtitle: 'Trader', jobdescription: "make mad money", postinglink: 'www.trademaster.com', dateofposting: '10/15/11', salary: '10', careerfield: 'finance', dateappliedto: '12/1/11')
